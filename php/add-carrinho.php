...
if (isset($_GET['idProduto']) && isset($_GET['quantidade']) && isset($_GET['userid'])) {
    ...
    if ($check_product_result->num_rows > 0) {
        ...
        header("Location: ../produtos.php?categoria=$categoria&idProduto=$idProduto&quantidade=$quantidade");
        //echo "O erro tá aqui <br> $produto_name , $produto_img , $produto_preco , $categoria , $quantidade, $userid";
    }
} 
?>
